    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#F8FAFB' }}>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 10 }}>
          <h1 style={{ fontSize: isMobile ? '28px' : '42px', fontWeight: 'bold', marginBottom: '12px', color: '#000000' }}>
            How It Works
          </h1>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: isMobile ? '40px 16px 64px' : '56px 20px 80px' }}>
        ...
        <div style={{ marginBottom: '56px' }}>
          <h2 style={{
            fontSize: isMobile ? '22px' : '28px', fontWeight: 'bold', color: '#fcd03a', marginBottom: '24px',
        ...
        <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: '24px' }}>
            <div>
              <h4 style={{ fontSize: '15px', fontWeight: '700', color: '#fcd03a', marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '12px', flexWrap: 'wrap' }}>
            <button
              ...
              style={{
                padding: '14px 32px',
                background: '#000000',
                color: '#fcd03a', borderRadius: '50px', fontSize: '16px', fontWeight: '700',
            ...
            <button
              ...
              style={{
                ...
                background: 'none',
                color: '#fcd03a', borderRadius: '50px', fontSize: '16px', fontWeight: '700',
                border: '2px solid #fcd03a', cursor: 'pointer',
              }}
            >
              Sign Up
            </button>
